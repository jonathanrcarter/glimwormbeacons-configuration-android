...
*/
	...
	public void populateView(ViewHolder vh) {
		System.out.println("BATT: "+ getBatteryLevel());
	   ...
	   //     vh.deviceAddress.setText(getDevice().getAddress());
	        ...
	        if(getBatteryLevel() >= 75) vh.batteryLevel.setImageResource(R.drawable.batt_100);
	        else if(getBatteryLevel() >= 50) vh.batteryLevel.setImageResource(R.drawable.batt_75);
	        else if(getBatteryLevel() >= 25) vh.batteryLevel.setImageResource(R.drawable.batt_50);
	        else if(getBatteryLevel() > 0) vh.batteryLevel.setImageResource(R.drawable.batt_25);
